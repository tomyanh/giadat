...
<table class='table table-bordered ' width="100%" id = 'tb_ketqua'>
    ...
    <tr>
        <th>1</th>
        <td><div id="div_b1_d1c1">{d1_lua}</div></td>
        <td><div id="div_b1_d1c2">{d1_cln}</div></td>
        <td rowspan='4'><div id="div_b1_d1c3">{d1_rsx}</div></td>
        <td rowspan='4'><div id="div_b1_d1c4">{d1_nts}</div></td>
        <td><div id="div_b1_d1c5">{d1_odt}</div></td>
        <td><div id="div_b1_d1c6">{d1_tdv}</div></td>
        <td><div id="div_b1_d1c7">{d1_skc}</div></td>
    </tr>
    <tr>
        <th>2</th>
        <td><div id="div_b1_d2c1">{d2_lua}</div></td>
        <td><div id="div_b1_d2c2">{d2_cln}</div></td>
        <td><div id="div_b1_d2c5">{d2_odt}</div></td>
        <td><div id="div_b1_d2c6">{d2_tdv}</div></td>
        <td><div id="div_b1_d2c7">{d2_skc}</div></td>
    </tr>
    <tr>
        <th>3</th>
        <td><div id="div_b1_d3c1">{d3_lua}</div></td>
        <td><div id="div_b1_d3c2">{d3_cln}</div></td>
        <td><div id="div_b1_d3c5">{d3_odt}</div></td>
        <td><div id="div_b1_d3c6">{d3_tdv}</div></td>
        <td><div id="div_b1_d3c7">{d3_skc}</div></td>
    </tr>
    <tr>
        <th>4</th>
        <td><div id="div_b1_d4c1">{d4_lua}</div></td>
        <td><div id="div_b1_d4c2">{d4_cln}</div></td>
        <td><div id="div_b1_d4c5">{d4_odt}</div></td>
        <td><div id="div_b1_d4c6">{d4_tdv}</div></td>
        <td><div id="div_b1_d4c7">{d4_skc}</div></td>
    </tr>
</table>
